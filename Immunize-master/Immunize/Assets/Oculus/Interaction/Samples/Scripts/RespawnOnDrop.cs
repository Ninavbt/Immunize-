...
namespace Oculus.Interaction.Samples
{
    public class RespawnOnDrop : MonoBehaviour
    {
        ...
        [SerializeField]
        private float _xThresholdForRespawn;

        [SerializeField]
        private float _zThresholdForRespawn;

        [SerializeField]
        private float _yLowThresholdForRespawn;

        [SerializeField]
        private float _xLowThresholdForRespawn;

        [SerializeField]
        private float _zLowThresholdForRespawn;
        ...
        protected virtual void Update()
        {
            ...
            if (transform.position.y > _yThresholdForRespawn || transform.position.x > _xThresholdForRespawn || transform.position.z > _zThresholdForRespawn || transform.position.y < _yLowThresholdForRespawn || transform.position.x < _xLowThresholdForRespawn || transform.position.z < _zLowThresholdForRespawn)
            {
